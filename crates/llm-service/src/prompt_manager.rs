...
impl PromptManager {
    ...
    pub fn validate_template_variables(&self, name: &str, variables: &HashMap<String, String>) -> Result<(), Vec<String>> {
...
mod tests {
    ...
    fn test_template_rendering() {
        ...
        variables.insert("context".to_string(), "The user is asking about weather. ".to_string());
        variables.insert("user_input".to_string(), "What's the weather like?".to_string());
    ...
    fn test_template_management() {
        ...
        assert!(manager.list_templates().len() > 0);

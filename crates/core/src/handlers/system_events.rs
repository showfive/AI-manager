use ai_manager_shared::{SystemEvent, SystemError, Result};
...
mod tests {
    ...
    async fn test_multiple_events() {
        ...
        let events = vec![
            SystemEvent::ServiceStarted { service_id: "service1".to_string() },
            SystemEvent::ServiceStopped { service_id: "service2".to_string() },
